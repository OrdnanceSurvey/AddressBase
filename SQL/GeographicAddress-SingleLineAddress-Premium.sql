...
addressbasepremium.blpu AS b, addressbasepremium.street_descriptor AS s,
addressbasepremium.lpi AS l full outer join addressbasepremium.organisation AS o on (l.uprn = o.uprn) WHERE b.uprn = l.uprn
AND l.usrn = s.usrn
